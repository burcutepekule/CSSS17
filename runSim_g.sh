...
cd /Users/greg/Desktop/
mkdir SIM_${last}
cd /Users/greg/Desktop/SIM_${last}/
mkdir JacobianData
mkdir DATA

cd /Users/greg/Desktop/CSSS17/MATLAB
...
cd /Users/greg/Desktop/CSSS17/cpp
c++ -std=c++11 main.cpp -o exe -I/usr/local/include -I/usr/local/Cellar/eigen/3.3.3/include/eigen3 -I/usr/greg -L/usr/local/lib -lgsl -lgslcblas

root0=/Users/greg/Desktop/SIM_${last}/DATA/
cd $root0
...
rm -r /Users/greg/Desktop/SIM_${last}
